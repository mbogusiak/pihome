...
//	}
//	@Transformer(inputChannel = "weatherInputChannel", outputChannel = "weatherSoapChannel")
//	public HeaderEnricher soapActionEnricher() {
//	    Map<String, ? extends HeaderValueMessageProcessor<?>> headersToAdd =
//	            Collections.singletonMap("emailUrl",
//	                      new StaticHeaderValueMessageProcessor<String>("http://www.webserviceX.NET/GetWeather"));
...
////		
////	<bean id="weatherResponseStringTransformer" class="com.marcin.weather.transfomer.WeatherTransformer" scope="prototype" />
////
////
////	<int-xml:unmarshalling-transformer
////		id="defaultUnmarshaller" input-channel="outChannel" output-channel="outputWeatherChannel"
